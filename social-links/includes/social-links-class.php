 ...
 */
  public function getForm($instance)
  {
    ...
    if (isset($instance['facebook_link'])) {
      ...
      $facebook_link = 'http://www.faceboddddok.com';
    }
    // Get Twitter Link
...
<p>
    ...
    <input type="text" id="<?php echo $this->get_field_id('twitter_link'); ?>" name="<?php echo $this->get_field_name('twitter_link'); ?> " type='text' value="<?php echo esc_attr($twitter_link); ?>" class="widefat">
</p>
<p>
    <label for="<?php echo $this->get_field_id('twitter_icon') ?> "><?php _e('Icon:'); ?></label>
    <input type="text" id="<?php echo $this->get_field_id('twitter_icon'); ?>" name="<?php echo $this->get_field_name('twitter_icon'); ?> " type='text' value="<?php echo esc_attr($twitter_icon); ?>" class="widefat">
</p>
...
<p>
    ...
    <input type="text" id="<?php echo $this->get_field_id('linkedin_link'); ?>" name="<?php echo $this->get_field_name('linkedin_link'); ?> " type='text' value="<?php echo esc_attr($linkedin_link); ?>" class="widefat">
</p>
<p>
    <label for="<?php echo $this->get_field_id('linkedin_icon') ?> "><?php _e('Icon:'); ?></label>
    <input type="text" id="<?php echo $this->get_field_id('linkedin_icon'); ?>" name="<?php echo $this->get_field_name('linkedin_icon'); ?> " type='text' value="<?php echo esc_attr($linkedin_icon); ?>" class="widefat">
</p>
...
<p>
    ...
    <input type="text" id="<?php echo $this->get_field_id('google_link'); ?>" name="<?php echo $this->get_field_name('google_link'); ?> " type='text' value="<?php echo esc_attr($google_link); ?>" class="widefat">
</p>
<p>
    <label for="<?php echo $this->get_field_id('google_icon') ?> "><?php _e('Icon: '); ?></label>
    <input type="text" id="<?php echo $this->get_field_id('google_icon'); ?>" name="<?php echo $this->get_field_name('google_icon'); ?> " type='text' value="<?php echo esc_attr($google_icon); ?>" class="widefat">
</p>
 ...
 *
 * @param array $links The widget options
 * @param array $icons The widget options
 * @param array $icon_width The widget options
 * 
 */
